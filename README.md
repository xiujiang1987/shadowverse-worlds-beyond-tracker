...
### v1.5.0 (當前版本 - 2025-07-02) 🚨
- **緊急修復**: 修正初始化錯誤，應用程式現在可正常啟動
- **程式碼重構**: 完成分組(Group)與階級(Rank)概念統一
- **錯誤修復**: 修正 `autoAdjustRank` 和 `analyzeRankStatus` 方法不存在的問題
- **代碼清理**: 移除重複方法定義，統一函數命名
- **穩定性提升**: 全面測試確保應用程式正常運作
